...
| File | Covers | Status |
|---|---|---|
| `ci-next-01-dependabot-plan.md` | Dependabot on `main`, targeting `develop` | rev 3 — ready; priority follows push CI |
...
| `ci-next-04-forge-fmt-plan.md` | `forge fmt` + `--check` step (Phase 1 PR 4) | rev 2 — compiled-output verification corrected |
| `ci-next-05-develop-push-and-completion-plan.md` | `develop` push CI, concurrency, Phase 1 completion order, docs and scheduled integration | rev 3 — final audit corrections incorporated |
